<template>
    <div id="list">
        <el-table :data="pageList">
            ...
            <el-table-column prop="sub_title" label="名称"></el-table-column>
...
export default {
    ...
    methods:{
        ...
        handleCurrentChange: function(currentPage) {
            ...
            this.currentChangePage(this.newsList,currentPage)
        },
        //分页方法（重点）
        currentChangePage(list,currentPage) { 
            let from = (currentPage - 1) * this.pageSize;
            let to = currentPage * this.pageSize;
            this.tempList = this.newsList.slice(from,to);
        ...
        async fetch(){
            ...
            this.pageList=this.newsList.slice(0,this.pageSize);
        },
        async remove(row){
